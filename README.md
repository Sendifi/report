...
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Participa efectivamente en equipos de trabajo, asumiendo roles y fomentando un entorno colaborativo e inclusivo.                                       | **TB1**<br><br>**Aguirre Eneque, Joan Elias:** Participó activamente en las reuniones iniciales, aportando ideas para el problema y la propuesta de valor, y manteniendo una actitud abierta al feedback de sus compañeros.<br><br>**Esquirva León, Miguel Juan Diego:** Contribuyó en la identificación de los segmentos objetivo y apoyó a sus compañeros cuando necesitaban aclaraciones sobre el alcance del proyecto.<br><br>**Osores Marchese, Pietro:** Ayudó a coordinar las primeras sesiones de trabajo, promoviendo un ambiente en el que todos pudieran opinar y ser escuchados.<br><br>**Cossar Sanchez, Eduardo Jose:** Asumió un rol de organización en las discusiones, guiando la conversación para llegar a acuerdos y sintetizando los aportes del equipo.<br><br>**Payesa Torres, Harrison Hubert:** Se mantuvo constante en las reuniones, reforzando ideas de sus compañeros y colaborando en la toma de decisiones de manera respetuosa y constructiva.<br><br>**TP1**<br><br>**Joan:** Participó en la planificación de entrevistas y en la distribución de quién se encargaría de cada usuario, apoyando a los compañeros que tenían dudas sobre la dinámica.<br><br>**Miguel:** Colaboró en la preparación de las preguntas y escuchó de forma activa los hallazgos de los demás, integrándolos en una visión compartida del usuario.<br><br>**Pietro:** Facilitó la discusión de los resultados de las entrevistas, animando a que todos comenten sus observaciones sin que ninguna opinión quede de lado.<br><br>**Eduardo:** Ayudó a conectar los hallazgos de cada integrante, generando consenso sobre los principales pain points y manteniendo el enfoque del equipo.<br><br>**Harrison:** Participó comentando ejemplos concretos de los usuarios entrevistados y reforzó la importancia de considerar todas las perspectivas al definir las necesidades.<br><br>**TB2**<br><br>**Joan:** Colaboró en las decisiones de arquitectura y diseño, apoyando a otros integrantes en la comprensión de los modelos propuestos y resolviendo dudas en grupo.<br><br>**Miguel:** Contribuyó al trabajo colaborativo en el diseño de interfaz, aceptando sugerencias sobre mejoras visuales y de usabilidad.<br><br>**Pietro:** Apoyó en la revisión de diagramas y modelos, asegurando que las propuestas de todos sean consideradas antes de cerrar una versión final.<br><br>**Eduardo:** Lideró varias sesiones de integración entre arquitectura, UX y requerimientos, conciliando las opiniones técnicas y de negocio para mantener la cohesión del equipo.<br><br>**Harrison:** Se mantuvo disponible para apoyar tareas de documentación y revisión, mostrando flexibilidad para asumir tareas que equilibraran la carga del equipo.<br><br>**TF**<br><br>**Joan:** Colaboró activamente en la preparación de la exposición final, practicando con el equipo para asegurar que todos se sintieran cómodos al presentar.<br><br>**Miguel:** Coordinó con sus compañeros la demostración de ciertas funcionalidades, ajustando el orden de la demo para que cada uno tuviera un rol visible.<br><br>**Pietro:** Acompañó y reforzó las intervenciones de sus compañeros durante la presentación, interviniendo cuando era necesario complementar información.<br><br>**Eduardo:** Ejerció un rol de liderazgo en la preparación del pitch final, organizando los tiempos y asegurando que todas las voces del equipo estuvieran representadas.<br><br>**Harrison:** Participó apoyando la explicación de distintas secciones del trabajo, y brindó soporte al equipo durante la sesión de preguntas, manteniendo un ambiente de respeto y apoyo mutuo. | **TB1:** En la TB1, el equipo demostró una buena base de trabajo colaborativo, compartiendo ideas y escuchando diferentes puntos de vista para definir el problema y la propuesta de valor, lo que permitió construir una visión común del proyecto.<br><br>**TP1:** En la TP1, el trabajo en equipo se fortaleció al coordinar entrevistas y analizar hallazgos de manera conjunta, fomentando un entorno inclusivo en el que todas las experiencias con usuarios aportaron a la comprensión global de las necesidades.<br><br>**TB2:** En la TB2, la colaboración se orientó hacia decisiones más técnicas y de diseño; el equipo logró integrar arquitectura, UX y requisitos funcionales mediante sesiones de discusión donde se respetaron los roles y se valoraron los aportes de cada integrante.<br><br>**TF:** En el trabajo final, el grupo evidenció un funcionamiento maduro como equipo, coordinando la exposición y la demo de forma que todos participaran, apoyándose mutuamente y presentando el producto de manera cohesionada frente a la audiencia. |
| Establece metas, planifica tareas y cumple responsabilidades para lograr los objetivos del equipo dentro de los plazos establecidos.                    | **TB1**<br><br>**Aguirre Eneque, Joan Elias:** Asumió responsabilidades en la elaboración de secciones específicas del documento inicial y cumplió con los tiempos acordados para avanzar con la entrega.<br><br>**Esquirva León, Miguel Juan Diego:** Se encargó de investigar parte del contexto y de los referentes, entregando la información a tiempo para integrarla en el informe.<br><br>**Osores Marchese, Pietro:** Participó en la definición de tareas para la TB1 y se responsabilizó de completar apartados del perfil de la startup, siguiendo el plan del equipo.<br><br>**Cossar Sanchez, Eduardo Jose:** Ayudó a organizar el cronograma de la TB1 y verificó que el contenido estuviera listo para revisión antes de la fecha límite.<br><br>**Payesa Torres, Harrison Hubert:** Cumplió con la redacción de secciones asignadas sobre el problema y el mercado, entregándolas en el plazo acordado.<br><br>**TP1**<br><br>**Joan:** Se comprometió con la planificación y ejecución de entrevistas, coordinando horarios con los participantes y entregando sus registros a tiempo.<br><br>**Miguel:** Asumió tareas de análisis de entrevistas y elaboración de mapas (personas, journeys), respetando los plazos definidos en el plan de trabajo.<br><br>**Pietro:** Apoyó la consolidación de resultados de investigación y cumplió con la entrega de insumos para la construcción de las matrices y diagramas.<br><br>**Eduardo:** Supervisó el progreso de las tareas de TP1, ajustando el plan cuando fue necesario para asegurar que se cumpliera con la fecha de entrega.<br><br>**Harrison:** Colaboró en la documentación de hallazgos y conclusiones, entregando sus aportes dentro del tiempo establecido por el equipo.<br><br>**TB2**<br><br>**Joan:** Se responsabilizó por completar partes de los diagramas de arquitectura y se aseguró de que estuvieran listos para revisión conjunta antes del cierre de la entrega.<br><br>**Miguel:** Planificó y ejecutó tareas relacionadas con el diseño de interfaz, organizando su tiempo para avanzar de acuerdo con el backlog de TB2.<br><br>**Pietro:** Cumplió con la preparación de secciones del diseño de base de datos y apoyó en la revisión de consistencia de los modelos, siguiendo las fechas definidas.<br><br>**Eduardo:** Coordinó la integración de contenido de arquitectura, diseño y modelo de datos, verificando que cada responsabilidad estuviera cumplida según el cronograma.<br><br>**Harrison:** Se encargó de la documentación de aspectos específicos de la solución y actualizó el informe TB2 con sus aportes en los plazos establecidos.<br><br>**TF**<br><br>**Joan:** Gestionó parte de las tareas finales de documentación, asegurando que las secciones a su cargo estuvieran completas y alineadas con el resto del informe.<br><br>**Miguel:** Planificó su tiempo para terminar evidencias de implementación y capturas de pantalla, entregándolas a tiempo para la edición final.<br><br>**Pietro:** Cumplió con la consolidación de información de modelos y diagramas en el documento definitivo, respetando los plazos internos del equipo.<br><br>**Eduardo:** Actuó como coordinador del cronograma final, verificando el avance del documento, la preparación del video y la demo para cumplir con la fecha de entrega oficial.<br><br>**Harrison:** Completó secciones finales relacionadas con despliegue y recomendaciones, y apoyó en la revisión general del documento antes de su envío. | **TB1:** En la TB1, el equipo logró definir metas básicas y distribuir tareas de forma equitativa, cumpliendo con la preparación del documento inicial dentro de los plazos y marcando una primera experiencia de planificación conjunta.<br><br>**TP1:** En la TP1, la planificación se volvió más detallada al incluir entrevistas y análisis; el grupo coordinó horarios, tareas y entregas parciales, demostrando una mejor organización para integrar insumos de investigación a tiempo.<br><br>**TB2:** En la TB2, el equipo estructuró su trabajo alrededor de un backlog de arquitectura, diseño y modelo de datos, lo que permitió avanzar de manera ordenada y cumplir con una entrega más compleja sin retrasos significativos.<br><br>**TF:** En el trabajo final, la planificación y cumplimiento de responsabilidades se reflejaron en la integración exitosa del documento, la demo y el video en los tiempos establecidos, evidenciando que el equipo puede organizarse y ejecutar un proyecto completo respetando los plazos académicos.|
